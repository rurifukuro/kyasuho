...
**2026-07-06 ユーザー追加指示で T8〜T16 を追加**（出勤表画像／キャスト写真個人登録／予約画面のconcafe-yoyaku仕様化／キャスト毎予約ビュー・席埋まり／卓割振り＋最低卓時間／**T13 キャストアカウント基盤=招待制＋ログイン2系統／T14 パスワードリセット＋パスキー推奨ログイン／T15 キャスト個人の給与閲覧／T16 店舗独自テンプレートの取り込み**）。
